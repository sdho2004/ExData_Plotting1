...
##unlink(temp)
    ...
    ## Plot 4 graphs on a page per instructions
    par(mfrow = c(2,2))
    
    ## Plot a line graph based on Global Active Power and Time
    plot(subhhps$Time, subhhps$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "" )
    
    ## Plot a line graph based on Voltage and Time
    plot(subhhps$Time, subhhps$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
    ...
    ## Plot a line graph based on Global Reactive Power and Time
    plot(subhhps$Time, subhhps$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
